...
public partial class PasswordFieldEditor
{
    ...
    public static readonly DependencyProperty HeaderProperty = DependencyProperty.Register(
        nameof(Header), typeof(string), typeof(PasswordFieldEditor), new PropertyMetadata(default(string)));
    ...
    public static readonly DependencyProperty UnitProperty = DependencyProperty.Register(
        nameof(Unit), typeof(string), typeof(PasswordFieldEditor), new PropertyMetadata(default(string)));
    ...
    public static readonly DependencyProperty HeaderStyleProperty = DependencyProperty.Register(
        nameof(HeaderStyle), typeof(Style), typeof(PasswordFieldEditor), new PropertyMetadata(default(Style)));
    ...
    public static readonly DependencyProperty ValueStyleProperty = DependencyProperty.Register(
        nameof(ValueStyle), typeof(Style), typeof(PasswordFieldEditor), new PropertyMetadata(default(Style)));
    ...
    public static readonly DependencyProperty UnitStyleProperty = DependencyProperty.Register(
        nameof(UnitStyle), typeof(Style), typeof(PasswordFieldEditor), new PropertyMetadata(default(Style)));
    ...
    public static readonly DependencyProperty IsReadOnlyProperty = DependencyProperty.Register(
        nameof(IsReadOnly), typeof(bool), typeof(PasswordFieldEditor), new PropertyMetadata(false));
